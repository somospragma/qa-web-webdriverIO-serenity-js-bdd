...
class Select {
    ...
    static values(...values) {
        return {
            from: (pageElement) => core_1.Interaction.where(`#actor selects values ${(0, io_1.commaSeparated)(values.flat(), item => (0, stringified_1.stringified)(item, { inline: true }))} from ${(0, stringified_1.stringified)(pageElement, { inline: true })}`, async (actor) => {
    ...
    static options(...values) {
        return {
            from: (pageElement) => core_1.Interaction.where(`#actor selects ${(0, io_1.commaSeparated)(values.flat(), item => (0, stringified_1.stringified)(item, { inline: true }))} from ${(0, stringified_1.stringified)(pageElement, { inline: true })}`, async (actor) => {
                const answers = await (0, io_1.asyncMap)(values, value => actor.answer(value));
